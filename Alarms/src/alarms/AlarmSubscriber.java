...
public class AlarmSubscriber {
    ...
    public AlarmSubscriber(CallBackMessage callBackMessage) {
    ...
    public void start() {
        try {
            ...
            client = new MqttClient(serverURI, String.format("Alarm_%d",
    ...
    public class MQTTCallBack implements MqttCallbackExtended {
        ...
        public void messageArrived(String topic, MqttMessage mm) throws Exception {
            ...
            m.setTopic(topic);
            m.setMessage(new String(mm.getPayload()));
            callBackMessage.listener(m);
//            FXMLAlarmController.tableView.getItems().add(m);
//            FXMLAlarmController.getInstance().loadTable(m);
        }
